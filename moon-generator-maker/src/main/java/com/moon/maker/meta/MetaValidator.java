...
import com.moon.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "moon");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.moon");
